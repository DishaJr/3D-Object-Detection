...
exec_visualization = ['show_detection_performance', 'make_tracking_movie'] # options are 'show_range_image', 'show_bev', 'show_pcl', 'show_labels_in_image', 'show_objects_and_labels_in_bev', 'show_objects_in_bev_labels_in_camera', 'show_tracks', 'show_detection_performance', 'make_tracking_movie'
    ...
    try:
        ...
        if (configs_det.use_labels_as_objects==True):
            ...
            if 'detect_objects' in exec_list:
                ...
                detections = load_object_from_file(results_fullpath, data_filename, dets_fp_ext, cnt_frame)
